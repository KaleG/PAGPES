<%@ Page Title="UnSubmitted Plan" Language="C#" MasterPageFile="~/SharedResources/Site1.Master" AutoEventWireup="true" CodeBehind="ReportUnsubmittedPlan.aspx.cs" Inherits="PES.Presentation.ReportUnsubmittedPlan" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="row" style="width:95%;margin-left:2%;">
        <div class="col-lg-6">
            <h5>UnSubmitted Plans</h5>
            <asp:ListBox ID="ListBox1" runat="server" Font-Names="Book Antiqua" Height="100%" Width="95%" Style="margin-left: 10px;" Rows="20"></asp:ListBox>

        </div>
        <div class="col-lg-6">
            <h5>Submitted Plans</h5>
            <asp:ListBox ID="ListBox2" runat="server" Font-Names="Book Antiqua" Height="100%" Width="95%" Style="margin-left: 10px;" Rows="20"></asp:ListBox>
        </div>
    </div>
