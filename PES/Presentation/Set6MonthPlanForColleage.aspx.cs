        ...
        protected void btnCleare_Click(object sender, EventArgs e)
        {
           // string selectedLanguage = Session["SelectedLanguage"].ToString();
            ...
            List<DataAccess.SixMonthPlan> ToBeDeleted = (from cex in db.SixMonthPlans
                                                         where cex.PlanSetForEmployeeId == Convert.ToInt32(Session["EmployeeSelectedToBeEvaluated"]) &&
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
           // string selectedLanguage = Session["SelectedLanguage"].ToString();
            ...
            DataAccess.SixMonthPlan checkExistance234 = (from cext in db.SixMonthPlans
                                                           where cext.PlanSetForEmployeeId == Convert.ToInt32(Convert.ToInt32(DDLEvaluatedEmployee.SelectedValue)) &&
            ...
            else
            {
                ...
                ep2.PlanSetForEmployeeId = Convert.ToInt32(Convert.ToInt32(DDLEvaluatedEmployee.SelectedValue));
...
&& evd.PlanSetForEmployeeId == Convert.ToInt32(Convert.ToInt32(DDLEvaluatedEmployee.SelectedValue)) && evd.PlanSetByEmployeeId == loggerId &&
evd.EvaluationPeriod == Convert.ToInt32(Session["EvaluationPeriod"])
                               select evd).SingleOrDefault();
