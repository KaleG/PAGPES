...
namespace PES.Presentation
{
    public partial class AllEmployeesReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(Session["UserRole"]) == 2 || Convert.ToInt32(Session["UserRole"]) == 1 || Convert.ToInt32(Session["UserRole"]) == 5) {
                DDLEvaluators.DataSourceID = string.Empty;
                DDLEvaluators.DataSource = SQLSEvaluatorList;
                DDLEvaluators.DataTextField = "FullENName";
                DDLEvaluators.DataValueField = "Id";
            }
        }
