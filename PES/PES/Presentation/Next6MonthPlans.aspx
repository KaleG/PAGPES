<%@ Page Title="" Language="C#" MasterPageFile="~/SharedResources/Site1.Master" AutoEventWireup="true" CodeBehind="Next6MonthPlans.aspx.cs" Inherits="PES.Presentation.Next6MonthPlans" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="width:95%; margin-left:2%; overflow-y: scroll; background-color: #f2f2f2; margin-bottom: 40px;margin-top: 40px; height: 100px">
        ...
        <div class="col-lg-2">
            <asp:Button Style="width: 100%; margin: 5px;" CssClass="btn btn-primary" ID="BtnSave" runat="server" Text="Save" OnClick="BtnSave_Click" />
        </div>
        <div class="col-lg-2">
            <asp:Button Style="width: 100%; margin: 5px;" CssClass="btn btn-primary" ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" />
        </div>
    </div>
