<%@ Page Title="Evaluate your Colleague " Language="C#" MasterPageFile="~/SharedResources/Site1.Master" AutoEventWireup="true" CodeBehind="MidTermColleagueEvaluation.aspx.cs" Inherits="PES.Presentation.MidTermColleagueEvaluation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style=" width:95%; margin-left:2%;background-color: #f2f2f2; margin-bottom: 40px;margin-top: 40px; height: 100px">
        ...
        <asp:TextBox EnableViewState="false" CssClass="form-control" ID="TARAdditionalPoints" TextMode="MultiLine" cols="20" rows="3" runat="server"></asp:TextBox>
    </div>
