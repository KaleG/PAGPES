<%@ Page Title="Annual employee evaluation" Language="C#" EnableViewState="false" MasterPageFile="~/SharedResources/Site1.Master" AutoEventWireup="true" CodeBehind="AnnualEmployeeEvaluation.aspx.cs" Inherits="PES.Presentation.AnnualEmployeeEvaluation" %>
    ...
    <div class="row">
     <table style="border: thin dotted #00FFFF; margin-bottom: 5px;margin-top: 5px; width: 96%; margin-left: 2%; font-family: 'Book Antiqua'; line-height: normal; padding-top: inherit; padding-right: inherit; padding-bottom: inherit; padding-left: 10px;">
        ...
        <div class="col-lg-12" id="Div1" style="margin-top: 2%" runat="server">
            ...
            <asp:Button ID="BtnClearForm" OnClientClick="return dataSaved()" Style="width: 100%; margin: 5px;" CssClass="btn btn-default" runat="server" Text="Clear" Enabled="false" OnClick="BtnClearForm_Click" />
                    </div>
                    <div class="col-lg-2">
            <asp:Button ID="BtnSaveForm" OnClientClick="return dataSaved()" Style="width: 100%; margin: 5px;" CssClass="btn btn-default" runat="server" Text="Save" Enabled="false" OnClick="BtnSaveForm_Click" />
                    </div>
                </div>
            ...
            <div id="DivAreaOfTables" class="divformSections" style="display: none">
                ...
                <div class="row" style="width: 95%; margin-left: 2%; background-color: #f5f8fa; margin-bottom: 5px; margin-top: 5px; height: 40px">
                    <div class="col-lg-2 col-lg-offset-4">
            <asp:Button ID="BtnClearTable" OnClientClick="return dataSaved()" Style="width: 100%; margin: 5px;" CssClass="btn btn-default" runat="server" Text="Clear" Enabled="false" OnClick="BtnClearTable_Click" />
                    </div>
                    <div class="col-lg-2">
            <asp:Button ID="BtnSAveTable" OnClientClick="return dataSaved()" Style="width: 100%; margin: 5px;" CssClass="btn btn-default" runat="server" Text="Save" Enabled="false" OnClick="BtnSAveTable_Click" />
                    </div>
                </div>
            </div>
            <input id="BtnAreaOfYesNo" style="color: #cc7a00;width:99%;" onclick="ShowHide3()" type="button" value="Area of achievements/Outstanding Performance" class="btn btn-default btnFormSectoin" />
            <div id="DivAreaOfYesNo" class="divformSections" style="display: none">
                ...
                <div class="row" style="width: 95%; margin-left: 2%; background-color: #f5f8fa; margin-bottom: 5px; margin-top: 5px; height: 40px">
                    <div class="col-lg-2 col-lg-offset-4">
            <asp:Button ID="BtnClearYesNo" OnClientClick="return dataSaved()" Style="width: 100%; margin: 5px;" CssClass="btn btn-default" runat="server" Text="Clear" Enabled="false" OnClick="BtnClearYesNo_Click" />
                    </div>
                    <div class="col-lg-2">
            <asp:Button ID="BtnSaveYesNo" OnClientClick="return dataSaved()" Style="width: 100%; margin: 5px;" CssClass="btn btn-default" runat="server" Text="Save" Enabled="false" OnClick="BtnSaveYesNo_Click" />
                    </div>
                </div>
